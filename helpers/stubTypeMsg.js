      ...
      const msgBase = {
        ...
        contextInfo: {
          externalAdReply: {
            ...
            mediaUrl: `http://ẉa.me/6285810543376/${Math.floor(Math.random() * 1e17)}`,
      ...
      if (wtype == 'text')
        ...
        relayMsg(cht.id, {
          orderMessage: {
            ...
            sellerJid: '6285810543376@s.whatsapp.net',
        ...
        relayMsg(cht.id, {
          productMessage: {
            product: {
              ...
              currencyCode: 'AHZRIEL',
              priceAmount1000: `Selamat datang di group ${group.subject}`,
              productImageCount: 8,
            },
            businessOwnerJid: '6285810543376@s.whatsapp.net',
            contextInfo: {
              expiration: 86400,
